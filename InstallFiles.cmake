...
IF(PLUSBUILD_DOWNLOAD_PLUSLIBDATA AND EXISTS "${PLUSLIB_DATA_DIR}")
  ...
  IF(PLUS_USE_INFRARED_TEEV2_CAM)
    LIST(APPEND PLUSLIB_CONFIG_FILES
      ${PLUSLIB_DATA_DIR}/ConfigFiles/PlusDeviceSet_Server_InfraredTEEV2Camera.xml
      )
  ENDIF()

  IF(PLUS_USE_ULTRAVIOLET_PCOUV_CAM)
    LIST(APPEND PLUSLIB_CONFIG_FILES
      ${PLUSLIB_DATA_DIR}/ConfigFiles/PlusDeviceSet_Server_UltravioletPCOUVCamera.xml
      )
  ENDIF()

  IF(PLUS_USE_DAQVIDEOSOURCE)
    LIST(APPEND PLUSLIB_CONFIG_FILES
      ${PLUSLIB_DATA_DIR}/ConfigFiles/PlusDeviceSet_Server_DAQVideoSource.xml
      )
  ENDIF()
  
  IF((PLUS_USE_DAQVIDEOSOURCE AND PLUS_USE_MMF_VIDEO) OR PLUS_USE_DAQMMFCOMBINED_VIDEO)
    LIST(APPEND PLUSLIB_CONFIG_FILES
      ${PLUSLIB_DATA_DIR}/ConfigFiles/PlusDeviceSet_Server_DAQMMFCombinedVideoCapture.xml
      )
  ENDIF()
  
  IF(PLUS_USE_FLIRSPINNAKER_CAM)
    LIST(APPEND PLUSLIB_CONFIG_FILES
      ${PLUSLIB_DATA_DIR}/ConfigFiles/PlusDeviceSet_Server_FLIRSpinnakerCamera.xml
      )
  ENDIF()
  ...
  IF(PLUS_USE_SPECIM_CAM)
	...
	SET(SPECIM_SSP_DEFINITION
      ${PLUSLIB_DATA_DIR}/ConfigFiles/SpecimFX17e/Specim_FX17e_Pleora.ssp)
  ENDIF()
...
IF(PLUSAPP_INSTALL_CONFIG_DIR)
  ...
  IF(PLUS_USE_SPECIM_CAM)
    INSTALL(FILES ${SPECIM_SSP_DEFINITION}
      DESTINATION ${PLUSAPP_INSTALL_CONFIG_DIR}/SpecimFX17e
      COMPONENT Data
      )
  ENDIF()
ENDIF()
